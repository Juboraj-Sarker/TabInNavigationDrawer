...
public class InflatorDetailsFragment extends Fragment {
    ...
    public InflatorDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_inflator_details, container, false);
